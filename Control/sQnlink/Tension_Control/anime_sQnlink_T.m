 function anime_sQ_2link(torig, xorig,xdesired,params,writeflag)
...
if writeflag
    aviobj = VideoWriter('2link_tensionCtrl_agrsv.avi','Uncompressed AVI'); 
    aviobj.FrameRate = 15;
    open(aviobj);
end
    for i=1:length(t)
...
s.hload = plot3(xLoad(1,1), xLoad(2,1), xLoad(3,1), 'ko', 'LineWidth',lwl) ;
