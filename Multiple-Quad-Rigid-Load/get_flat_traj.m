...
traj.dx{11}=[0.287309E3.*sin(0.15708E1.*t);(-0.359136E3).*cos(0.15708E1.*t);0];


traj.dx{12}=[0.451303E3.*cos(0.15708E1.*t);0.564129E3.*sin(0.15708E1.*t);0];


traj.dx{13}=[(-0.708906E3).*sin(0.15708E1.*t);0.886132E3.*cos(0.15708E1.*t);0];


traj.dx{14}=[(-0.111355E4).*cos(0.15708E1.*t);(-0.139193E4).*sin(0.15708E1.*t);0];
